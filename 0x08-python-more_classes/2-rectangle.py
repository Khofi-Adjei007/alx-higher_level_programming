...
The Rectangle class allows creating rectangle objects with
width and height attributes. It enforces that the width and height
are integers and non-negative values. The class also includes
